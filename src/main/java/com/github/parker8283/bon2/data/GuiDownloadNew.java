...
public class GuiDownloadNew extends JFrame {
    ...
    private static final String MAPPINGS_URL_SNAPSHOT = "https://maven.minecraftforge.net/de/oceanlabs/mcp/mcp_snapshot/%1$s-%2$s/mcp_snapshot-%1$s-%2$s.zip";
    private static final String MAPPINGS_URL_STABLE = "https://maven.minecraftforge.net/de/oceanlabs/mcp/mcp_stable/%1$s-%2$s/mcp_stable-%1$s-%2$s.zip";
